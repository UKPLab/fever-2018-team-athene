...
class ESIM(LSTM):
    ...
    def __init__(self, h_max_length=50, b_max_length=50, trainable=False, lstm_layers=2, mlp_layers=1,
                 ...
                 embedding=None, l2_lambda=0.01, vocab_size=None, n_outputs=3, pos_weight=None, n_sents=5):
        ...
        self.mlp_layers = len(num_neurons) - 2  # first 2 for the 2 BiLSTM
        self.vocab_size = vocab_size
        self.embedding_size = dim_ELMo
    ...
    def _ann(self, head_inputs, body_inputs, h_sent_sizes, b_sent_sizes):
        ...
        with tf.variable_scope("embedding_lookup") as scope:
            ...
            body_embeddings = tf.reshape(flat_body_embeddings,
                                         [-1, self.n_sents, self.b_max_length, self.embedding_size])
    ...
    def get_batch_attention(self, h_tokens, b_tokens, h_sizes, b_sizes, h_sent_sizes, b_sent_sizes, y=None):
        ...
        for i in range(num_batches):
            ...
            if y is not None:
                batches.append((batch_h_tokens, batch_b_tokens, batch_h_sizes, batch_b_sizes, batch_h_sent_sizes,
        ...
        with self._session.as_default() as sess:
            ...
            for epoch in range(self.num_epoch):
                ...
                if X_valid is not None and y_valid is not None:
                    ...
                    batches = self.get_batch_attention(valid_h_tokens, valid_b_tokens, valid_h_sizes, valid_b_sizes,
    ...
    def predict_probabilites(self, X):
        ...
        h_tokens, b_tokens, h_sizes, b_sizes, h_sent_sizes, b_sent_sizes = X['h_tokens'], X['b_tokens'], X['h_sizes'], \
                                                                           X['b_sizes'], X['h_sent_sizes'], X[
                                                                               'b_sent_sizes']
        batches = self.get_batch_attention(h_tokens, b_tokens, h_sizes, b_sizes, h_sent_sizes, b_sent_sizes)
        probabilities = []
